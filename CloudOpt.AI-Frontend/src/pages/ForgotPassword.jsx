...
export default function ForgotPassword({ onSwitchToLogin }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setErrorMessage(err.data?.message || err.message || 'Failed to request password reset. Please try again.');
    } finally {
        ...
        {successMessage ? (
          <div>
            <div style={{
              ...
              <div>
                <div style={{ fontWeight: 600, marginBottom: '0.25rem' }}>Reset Link Dispatched</div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{ marginBottom: '1.5rem' }}>
              ...
              <div style={{ position: 'relative' }}>
                <Mail size={17} color="var(--text-muted)" style={{
                  position: 'absolute',
                  left: '12px',
                  top: '50%',
